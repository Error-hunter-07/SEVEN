...
def get_working_memory():
    ...
    scratchpad_tool.add_scratchpad_tool_output("get_working_memory: Latest working memory row retrieved successfully.")
...
def get_all_working_memory_current_session():
    ...
    scratchpad_tool.add_scratchpad_tool_output(f"get_all_working_memory: Retrieved all working memory for current session")
